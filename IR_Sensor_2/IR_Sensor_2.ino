...
char Sensor3 = A2; //A2에 센서연결
int Sensor3_val; //센서 ADC값 저장 변수
char Sensor4 = A3; //A3에 센서연결
int Sensor4_val; //센서 ADC값 저장 변수
...
void loop() // 무한루프
{
  ...
  //Serial.println("Sum2");
  //Serial.println(Sum2);
  if(Sum1<Sum2 && Sum1>10)
  {
    if(Sum1 < 60 && Sum1 > 40) Serial.println("Left to Right, Two");
